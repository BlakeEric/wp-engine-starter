...
<head>
  ...
  <!-- Additional scripts and tags here -->
  <?php wp_head(); ?>
</head>
  ...
  <header id="masthead">
    <div class="logo">
      ...
      if ( has_custom_logo() ) :
        ...
        ?>
        <a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img alt="Logo" src="<?php echo esc_url( get_template_directory_uri() . '/images/eco-chat.svg' ); ?>"><span class="screen-reader-text"><?php esc_html_e( 'Home', 'susty' ); ?></span></a>
        <?php
      endif;
      ?>
    </div>
